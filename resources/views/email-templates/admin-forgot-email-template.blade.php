<p>Dear {{ $admin->name }}</p>
<p>
    We have received a request to reset the password for Ecommerce account associated with {{ $admin->email }}.
    ...
    box-shadow:0 2px 3px rgba(0,0,0,0.16);-webkit-text-size-adjust:none;box-sizing:border-box;">Reset Password
    </a>
    <br>
